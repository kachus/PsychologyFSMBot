...
LEXICON_RU: dict[str:str] = {
    ...
    'chose_old_beliefs': 'Проработать загон',
    ...
    'get_rid_of_emotion' : """Это чувство тепреь ощущается в большой силой, оно наполняет тебя, ты чувствуешь напряжение. Ты можешь выбросить это ощущение в пропасть. Сделай глубокий вдох и выход и выброси его! Раз, два, три! Мы снова находимся в начале нашего события""",
