...
LEXICON_RU: dict[str:str] = {
    ...
    'conclusion_practise': """Что ты теперь ощущаешь, после нашей практики? Так ои пугают тебя некоторые последствия? Много ли негативных эмоций осталось? Как ты чувствуешь себя по отношению к ситуации? Изменилось ли у тебя отношение к себе в сторону своего принятия и понимания себя?"""
